<div>
    <div class="mb-6">
        <h2 class="text-2xl font-bold tracking-tight text-surface-900">PD Netflow</h2>
        <p class="mt-1 text-sm text-surface-500">Hitung probabilitas default berdasarkan transisi bucket.</p>
    </div>
    @if (session('status'))
    ...
    <div class="card overflow-hidden p-0">
        <table class="min-w-full text-sm">
            ...
            <tbody class="divide-y divide-surface-200 bg-white">
                ...
                @empty
                    <tr><td colspan="4" class="px-5 py-8 text-center text-surface-500">Belum ada perhitungan PD.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
